...
import { Ocultar } from '../directivas/ocultar';
import { BackgroundColor } from '../directivas/background-color';


@Component({
  selector: 'app-tabla-personajes',
  standalone: true,
  imports: [NgFor, NgIf, NgClass, NgStyle, HoverZoomDirective, IsStarkDirective, Ocultar, BackgroundColor],
